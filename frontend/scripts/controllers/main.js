...
var app = angular.module('transacRedlineApp', [
  'ngRoute',
  'ngAnimate',
  'ngSanitize',
  'ui.bootstrap',
...
app.factory('transacContext', function(){
...
app.controller('TransacListCtrl', ['transacContext', '$scope', '$http', '$filter',  function(ctx, $scope, $http, $filter){
...
app.controller('TransacDetailCtrl', ['transacContext', '$filter', '$scope', '$http', '$routeParams', '_', '$q', '$sce',  function(transacContext, $filter, $scope, $http, $routeParams, _, $q, $sce){
  function ymd(date){
